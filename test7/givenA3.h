...
#define MAX_STR 100
static char coursesToCheck[][MAX_STR] ={"THIS_IS_ONE_HUNDRED_CHARACTERS_LONG_THIS_IS_ONE_HUNDRED_CHARACTERS_LONG_THIS_IS_ONE_HUNDRED_CHARAC", "THIS_IS_ONE_HUNDRED_CHARACTERS_LONG_THIS_IS_ONE_HUNDRED_CHARACTERS_LONG_THIS_IS_ONE____ANOTHER_ONE,"};
